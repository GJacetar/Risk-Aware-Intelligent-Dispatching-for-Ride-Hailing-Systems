...
CITY_NAME = "Chicago-A"
ZONE_MODE = "chicago_tract"
BASE_DIR = Path("/root/autodl-tmp/new/data/chiago")
RAW_DIR = Path("/root/autodl-tmp/new/data/chiago")
OUTPUT_DIR = Path("/root/autodl-tmp/new/data/chiago/processed")
...
ZONE_CANDIDATES = ['/root/autodl-tmp/new/data/chiago/geo_export_bbf57716-e851-4380-a37c-24fbe460c069.shp']
