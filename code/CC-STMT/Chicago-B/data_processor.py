...
CITY_NAME = "Chicago-B"
ZONE_MODE = "chicago_community"
BASE_DIR = Path("/root/autodl-tmp/new/data/chiago")
RAW_DIR = Path("/root/autodl-tmp/new/chicago-bigfull/raw")
OUTPUT_DIR = Path("/root/autodl-tmp/new/chicago-bigfull/processed")
GRAPH_PATH = Path("/root/autodl-tmp/new/data/chiago/chicago_drive_network.graphml")
POI_PATH = Path("/root/autodl-tmp/new/data/chiago/chicago_pois.geojson")
...
ZONE_CANDIDATES = ['/root/autodl-tmp/new/chicago-bigfull/raw/geo_export.shp', '/root/autodl-tmp/new/chicago-bigfull/raw/Boundaries - Community Areas/geo_export.shp', '/root/autodl-tmp/new/chicago-bigfull/raw/chicago_community_areas.geojson']
TRIP_FILES = ['/root/autodl-tmp/new/data/chiago/Transportation_Network_Providers_-_Trips_(2025-12).csv', '/root/autodl-tmp/new/data/chiago/Transportation_Network_Providers_-_Trips_(2026-1).csv', '/root/autodl-tmp/new/data/chiago/Transportation_Network_Providers_-_Trips_(2026-2).csv']
